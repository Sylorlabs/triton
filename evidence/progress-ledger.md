...
| E.mcp-specialized-mutations | pass | generated MCP tool schemas; `mcp-specialized-mutations` | Specialized mutation tools advertise `idempotency_key`/`expected_revision`, reject missing envelopes, commit once, and replay byte-inertly | Add remaining create/close/move/rotate/disconnect/reroute schemas |
